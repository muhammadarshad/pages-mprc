...
The verifier also enumerates every permutation-equivalence class of binary \([n+2,2,d\ge3]\) relation codes for \(3\le n\le17\) and checks Theorem~\ref{thm:jac} exactly. The class counts are:
\[
