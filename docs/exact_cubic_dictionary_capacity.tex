...
\newcommand{\CubCap}{\operatorname{Cap}}
...
\[
\CubCap_3(n,m)=\sum_{k=1}^{\min(3,n)}\binom nk,
\]
...
Let \(\CubCap_3(n,m)\) be the largest cardinality of a free independent family of cubic atoms in \(\Sym^3(R_m^n)\).
\end{definition}
...
For \(n=8\),
\[
\CubCap_3(8,m)=\binom81+\binom82+\binom83
=8+28+56
=92.
\]
